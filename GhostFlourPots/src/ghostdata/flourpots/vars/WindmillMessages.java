...
public class WindmillMessages {
    ...
    public static final String HOPPER_CONTROLS_EXAMINE = "These control the flow of grain from the hopper to the millstones.";
    ...
    public static final String LAST_FLOUR_IN_BIN = "You fill a pot with the last of the flour in the bin.";
